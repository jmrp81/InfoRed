 ...
 */
public class PedirIP extends javax.swing.JDialog {
    //Atributos
     ...
     * @param modal
     */
    public PedirIP(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        info = (InfoRed) parent;
        initComponents();
    ...
    /**
     * Metodo para ingresar la ip por teclado
     * @param evt 
     */
    private void buttonIngresarIPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonIngresarIPActionPerformed
        ...
        if(textCampo1.getText().equals("")||textCampo2.getText().equals("")||textCampo3.getText().equals("")||textCampo4.getText().equals("")){
            ...
            if((direccionIP[0]<=0 | direccionIP[0]>255) | (direccionIP[1]<=0 | direccionIP[1]>255) | (direccionIP[2]<=0 | direccionIP[2]>255) | (direccionIP[3]<=0 | direccionIP[0]>255)){
            JOptionPane.showMessageDialog(this, "Hay valores introducidos no validos", "ERROR de lectura", 1); 
            }else{   
